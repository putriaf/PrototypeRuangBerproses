                ...
                <div class="m-10 py-10">
                        ...
                        <div class="flex-1 flex flex-col md:flex-row">
                            <div class="w-full flex-1 mx-2">
                                <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                    <input type="text" class="p-1 px-2 w-full" name="topik" id="topik"
                                        value="{{ old('topik')}}">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col md:flex-row pb-4 mb-4">
                        ...
                        <div class="flex-1 flex flex-col md:flex-row">
                            <div class="w-full flex-1 mx-2">
                                <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                    <input type="text" class="p-1 px-2 w-full" name="diagnosis" id="diagnosis"
                                        value="{{ old('diagnosis')}}">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col md:flex-row pb-4 mb-4">
                        ...
                        <div class="flex-1 flex flex-col md:flex-row">
                            <div class="w-full flex-1 mx-2">
                                <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                    <input type="text" class="p-1 px-2 w-full" name="pernah_gabung" id="pernah_gabung"
                                        value="{{ old('pernah_gabung')}}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col md:flex-row pb-4 mb-4">
                        ...
                        <div class="flex-1 flex flex-col md:flex-row">
                            <div class="w-full flex-1 mx-2">
                                <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                    <input type="text" class="p-1 px-2 w-full" name="pengalaman" id="pengalaman"
                    ...
                    <div class="flex flex-col md:flex-row pb-4 mb-4">
                        ...
                        <div class="flex-1 flex flex-col md:flex-row">
                            <div class="w-full flex-1 mx-2">
                                <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                    <input type="text" class="p-1 px-2 w-full" name="fasilitator" id="fasilitator"
                                        value="{{ old('fasilitator')}}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col md:flex-row pb-4 mb-4">
                        ...
                        <div class="flex-1 flex flex-col md:flex-row">
                            <div class="w-full flex-1 mx-2">
                                <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                    <input type="text" class="p-1 px-2 w-full" name="teman_kelompok" id="teman_kelompok"
                                        value="{{ old('teman_kelompok')}}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col md:flex-row pb-4 mb-4">
                        ...
                        <div class="flex-1 flex flex-col md:flex-row">
                            <div class="w-full flex-1 mx-2">
                                <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                    <input type="text" class="p-1 px-2 w-full" name="alasan" id="alasan"
                                        value="{{ old('alasan')}}">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col md:flex-row pb-4 mb-4">
                        ...
                        <div class="flex-1 flex flex-col md:flex-row">
                            <div class="w-full flex-1 mx-2">
                                <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                    <input type="text" class="p-1 px-2 w-full" name="batasan_pribadi"
                                        id="batasan_pribadi" value="{{ old('batasan_pribadi')}}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col md:flex-row pb-4 mb-4">
                        ...
                        <div class="flex-1 flex flex-col md:flex-row">
                            <div class="w-full flex-1 mx-2">
                                <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                                    <input type="text" class="p-1 px-2 w-full" name="harapan" id="harapan"
                                        value="{{ old('harapan')}}">
                                </div>
                            </div>
                        </div>

  ...
  <section class="font-quicksand pt-16">
    ...
    @elseif(
      ...
      <div class="mx-auto container font-quicksand">
        <!-- Progress Form -->
        <form id="progress-form" class="p-4 progress-form" action="/layanan/support-group/daftar" method="POST"
          ...
          <section id="progress-form__panel-1" role="tabpanel" aria-labelledby="progress-form__tab-1" tabindex="0"
            ...
            <div class="sm:grid sm:grid-cols-2 md:grid-cols-2 sm:my-1 gap-4">
              ...
              <div class="mt-3 sm:mt-0 form__field">
                ...
                <select id="preferensi_jk_fasilitator" name="preferensi_jk_fasilitator" autocomplete="" required
                  class="rounded-md">
              ...
              <div class="mt-3 sm:mt-0 form__field">
                ...
                <select id="preferensi_jk_teman" name="preferensi_jk_teman" autocomplete="" required
                  class="rounded-md">
                  <option value="" disabled selected>Pilih jenis kelamin</option>
                  <option value="L">Laki-laki
                  </option>
          ...
          <section id="progress-form__panel-2" role="tabpanel" aria-labelledby="progress-form__tab-2" tabindex="0"
            ...
            <div class="grid grid-cols-1 gap-6 mt-6">
              ...
              <div class="mt-3 sm:mt-0 lg:mt-2 form__field">
                ...
                <textarea id="alasan" name="alasan" rows="3" class="rounded-lg xs:w-full sm:w-2/3 md:w-2/3 lg:w-2/3"
                  required></textarea>
              </div>
              <div class="mt-3 sm:mt-0 lg:mt-2 form__field">
                <label for="harapan">
                ...
                <textarea id="harapan" name="harapan" rows="3" class="rounded-lg xs:w-full sm:w-2/3 md:w-2/3 lg:w-2/3"
                  required></textarea>
              </div>
              <div class="mt-3 sm:mt-0 lg:mt-2 form__field">
                <label for="diagnosis">
                ...
                <textarea id="diagnosis" name="diagnosis" rows="3" class="rounded-lg xs:w-full sm:w-2/3 md:w-2/3 lg:w-2/3"
                  required></textarea>
              </div>
              <div class="mt-3 sm:mt-0 lg:mt-2 form__field">
                ...
                <textarea id="pengalaman" name="pengalaman" rows="3" class="rounded-lg xs:w-full sm:w-2/3 md:w-2/3 lg:w-2/3"
                  required></textarea>
              </div>
              <div class="mt-3 sm:mt-0 form__field">
                ...
                <div class="flex align-middle">
                  <div class="flex items-center mr-4">
                    <input id="terlibat_aktif" type="radio" value="Ya" name="terlibat_aktif" required
                  ...
                  <div class="flex items-center mr-4">
                    <input id="terlibat_aktif" type="radio" value="Tidak" name="terlibat_aktif" required
                      class="w-2 h-2 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="terlibat_aktif" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300 p-0">
                      Tidak</label>
                  </div>
              ...
              <div class="mt-3 sm:mt-0 form__field">
                ...
                <div class="flex align-middle">
                  <div class="flex items-center mr-4">
                    <input id="mengikuti_aturan" type="radio" value="Ya" name="mengikuti_aturan" required
                      class="w-2 h-2 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="mengikuti_aturan" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300 p-0">
                      Ya</label>
                  </div>
                  <div class="flex items-center mr-4">
                    <input id="mengikuti_aturan" type="radio" value="Tidak" name="mengikuti_aturan" required
                      class="w-2 h-2 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="mengikuti_aturan" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300 p-0">
                      Tidak</label>
                  </div>
              ...
              <div class="mt-3 sm:mt-0 form__field">
                ...
                <div class="flex align-middle">
                  <div class="flex items-center mr-4">
                    <input id="mengikuti_full" type="radio" value="Ya" name="mengikuti_full" required
                      class="w-2 h-2 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="mengikuti_full" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300 p-0">
                      Ya</label>
                  </div>
                  <div class="flex items-center mr-4">
                    <input id="mengikuti_full" type="radio" value="Tidak" name="mengikuti_full" required
                      class="w-2 h-2 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="mengikuti_full" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300 p-0">
                      Tidak</label>
                  </div>
              ...
              <div class="mt-3 sm:mt-0 lg:mt-2 form__field">
                ...
                <textarea id="batasan_pribadi" name="batasan_pribadi" rows="3"

  ...
  <section class="font-quicksand pt-16">
    ...
    @elseif(
      ...
      <div class="mx-auto container font-quicksand">
        <!-- Progress Form -->
        <form id="progress-form" class="p-4 progress-form" action="/layanan/professional-counseling/daftar" method="POST"
          ...
          <section id="progress-form__panel-1" role="tabpanel" aria-labelledby="progress-form__tab-1" tabindex="0"
            ...
            <div class="sm:grid sm:grid-cols-2 md:grid-cols-2 sm:my-1 gap-4">
              ...
              <div class="mt-3 sm:mt-0 form__field">
                ...
                <select id="procounseling_id" name="procounseling_id" autocomplete="" required class="rounded-md">
            ...
            <div class="sm:grid sm:grid-cols-2 md:grid-cols-2 sm:my-1 gap-4">
              <div x-data x-init="flatpickr($refs.datetimewidget, { wrap: true, enableTime: true, dateFormat: 'M j, Y h:i K' });" x-ref="datetimewidget"
                ...
                <label for="opsi_waktu1" class="form__field flex-grow block font-medium text-sm text-gray-700 mb-1">Opsi
                  Waktu
              ...
              <div x-data x-init="flatpickr($refs.datetimewidget, { wrap: true, enableTime: true, dateFormat: 'M j, Y h:i K' });" x-ref="datetimewidget"
                class="flatpickr container mx-auto mt-3 sm:mt-0 form__field">
                <label for="opsi_waktu2" class="form__field flex-grow block font-medium text-sm text-gray-700 mb-1">Opsi
                  Waktu
          ...
          <section id="progress-form__panel-2" role="tabpanel" aria-labelledby="progress-form__tab-2" tabindex="0"
            ...
            <div class="grid grid-cols-1 gap-6 mt-6">
              ...
              <div class="mt-3 sm:mt-0 form__field">
                ...
                <div class="flex align-middle">
                  <div class="flex items-center mr-4">
                    ...
                    <label for="konsumsi_alkohol" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300 p-0">
                      Ya</label>
                  </div>
                  <div class="flex items-center mr-4">
                ...
                <div class="flex align-middle">
                  <div class="flex items-center mr-4">
                    <input id="konsumsi_obat" type="radio" value="Ya" name="konsumsi_obat" required
                      class="w-2 h-2 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="konsumsi_obat" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300 p-0">
                      Ya</label>
                  </div>
                  <div class="flex items-center mr-4">
              ...
              <div class="mt-3 sm:mt-0 form__field">
                ...
                <textarea id="pola_tidur" name="pola_tidur" rows="3" class="rounded-lg xs:w-full sm:w-2/3 md:w-2/3 lg:w-2/3"
                  required></textarea>
              </div>
              <div class="mt-3 sm:mt-0 form__field">
                ...
                <textarea id="pola_makan" name="pola_makan" rows="3" class="rounded-lg xs:w-full sm:w-2/3 md:w-2/3 lg:w-2/3"
                  required></textarea>
              </div>
              <div class="mt-3 sm:mt-0 form__field">
                ...
                <div class="flex align-middle">
                  <div class="flex items-center mr-4">
                    <input id="menyakiti_diri" type="radio" value="Pernah" name="menyakiti_diri" required
                      class="w-2 h-2 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="menyakiti_diri" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300 p-0">
                      Pernah</label>
                  </div>
                  <div class="flex items-center mr-4">
                    <input id="menyakiti_diri" type="radio" value="Tidak Pernah" name="menyakiti_diri" required
                      class="w-2 h-2 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="menyakiti_diri" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300 p-0">
                      Tidak Pernah</label>
                  </div>

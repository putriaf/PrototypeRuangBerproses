...
<div class="font-montserrat my-10">
    ...
    <div class="flex justify-center item-center">
        <form method="POST" action="/layanan/professional-counseling/daftar" enctype="multipart/form-data" class="w-6/12">
        @csrf
        ...
        <div class="m-10 py-10">
            ...
            <div class="flex flex-col md:flex-row pb-4 mb-4">
                ...
                <div class="flex-1 flex flex-col md:flex-row">
                    <div class="w-full flex-1 mx-2">
                        <div class="my-2 p-1 bg-white flex border border-gray-200 rounded">
                            <input type="text" class="p-1 px-2 w-full" name="pendidikan_terakhir" id="pendidikan_terakhir" value="{{ old('pendidikan_terakhir')}}">
                        </div>
                    </div>
                </div>
            </div>

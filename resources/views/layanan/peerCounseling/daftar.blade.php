...
<section class="font-quicksand pt-16">
    ...
    <div class="mx-auto container font-quicksand">
        <!-- Progress Form -->
        <form id="progress-form" class="p-4 progress-form" action="/layanan/peer-counseling/daftar" method="POST" lang="en" novalidate enctype="multipart/form-data">
            @csrf
            <!-- Step Navigation -->
            ...
            <section id="progress-form__panel-2" role="tabpanel" aria-labelledby="progress-form__tab-2" tabindex="0" hidden class="min-h-[50vh] lg:h-[55vh] overflow-auto box-border">
                <div class="grid grid-cols-1 gap-6 mt-6">
                    <div class="mt-3 sm:mt-0 form__field">
                        ...
                        <textarea id="latar_belakang" name="latar_belakang" rows="3" class="rounded-lg xs:w-full sm:w-2/3 md:w-2/3 lg:w-2/3" required></textarea>
                    </div>
                    <div class="mt-3 sm:mt-0 form__field">
                        <label for="tujuan">
                    ...
                    <div class="mt-3 sm:mt-0 form__field">
                        ...
                        <textarea id="keluhan" name="keluhan" rows="3" class="rounded-lg xs:w-full sm:w-2/3 md:w-2/3 lg:w-2/3" required></textarea>
                    </div>
                </div>

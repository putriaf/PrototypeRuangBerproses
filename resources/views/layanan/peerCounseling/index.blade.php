...
<section class="font-quicksand">
    <div class="pt-52 sm:px-12 h-screen bg-hero-peercounseling bg-no-repeat bg-cover bg-center bg-fixed mx-auto text-center text-slate-100 xl:px-64">
        ...
        <a href="/layanan/peer-counseling/daftar" class="bg-gradient-to-r from-[#FB8D66] px-8 py-2 sm:px-10 sm:py-4 rounded-3xl font-semibold lg:mt-4 inline-block">Daftar
            Sekarang</a>
    ...
    <div class="grid md:grid-cols-2 gap-2 lg:m-20 my-10 mx-5">
        ...
        <div class="xs:mx-auto my-7 lg:m-auto sm:w-full">
            <div href="#" class="block bg-[#1D1F4E] text-white p-6 sm:max-w-sm rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            <div id="client-logos" class="owl-carousel text-center">
                <div class="item rounded-lg">
                    <div class="client-inners">
                        <img src="{{ asset('img/psychologists/ariyanto.png') }}" alt="Saint John" srcset="" class="max-w-fit rounded-lg mx-auto">
                        <p class="mt-2">Ariyanto Yanwar, M.Psi., Psikolog</p>
                    </div>
                </div>
                <div class="item">
                    <div class="client-inners">
                        <img src="{{ asset('img/psychologists/ayu.jpeg') }}" alt="Basuki Pratama Engineering" srcset="" class="max-w-fit rounded-lg mx-auto">
                        <p class="mt-2">Ayu Pradani S. Putri, M.Psi., Psikolog</p>
                    </div>
                </div>
                <div class="item">
                    <div class="client-inners">
                        <img src="{{ asset('img/psychologists/daniswara.jpeg') }}" alt="Daniswara Agusta Wijaya, M.Psi., Psikolog" srcset="" class="max-w-fit rounded-lg mx-auto">
                        <p class="mt-2">Daniswara Agusta Wijaya, M.Psi., Psikolog</p>
                    </div>
                </div>
                <div class="item">
                    <div class="client-inners">
                        <img src="{{ asset('img/psychologists/laurentia.jpg') }}" alt="Laurentia Wahyu Prastiti, S.Psi.,M.Psi.,Psikolog" srcset="" class="max-w-fit rounded-lg mx-auto">
                        <p class="mt-2">Laurentia Wahyu Prastiti, S.Psi.,M.Psi.,Psikolog</p>
                    </div>
                </div>
                <div class="item">
                    <div class="client-inners">
                        <img src="{{ asset('img/psychologists/lebda.jpeg') }}" alt="Lebda Katodhia., M.Psi., Psikolog" srcset="" class="max-w-fit rounded-lg mx-auto">
                        <p class="mt-2">Lebda Katodhia., M.Psi., Psikolog</p>
                    </div>
                </div>
                <div class="item">
                    <div class="client-inners">
                        <img src="{{ asset('img/psychologists/nica.jpg') }}" alt="Eukaristianica Theofani, M.Psi., Psikolog" srcset="" class="max-w-fit rounded-lg mx-auto">
                        <p class="mt-2">Eukaristianica Theofani, M.Psi., Psikolog</p>
                    </div>
                </div>
                <div class="item">
                    <div class="client-inners">
                        <img src="{{ asset('img/psychologists/rininta.jpg') }}" alt="Rininta Meyftanoria, S.Psi, M.Psi, Psikolog" srcset="" class="max-w-fit rounded-lg mx-auto">
                        <p class="mt-2">Rininta Meyftanoria, S.Psi, M.Psi, Psikolog</p>
                    </div>
                </div>
                <div class="item">
                    <div class="client-inners">
                        <img src="{{ asset('img/psychologists/stenny.jpg') }}" alt="Stenny Prawitasari, M. Psi., Psikolog" srcset="" class="max-w-fit rounded-lg mx-auto">
                        <p class="mt-2">Stenny Prawitasari, M. Psi., Psikolog</p>
                    </div>
                </div>
                <div class="item">
                    <div class="client-inners">
                        <img src="{{ asset('img/psychologists/tiara.jpg') }}" alt="Tiara Adjeng Endrastyana, S.Psi., M.Psi., Psikolog" srcset="" class="max-w-fit rounded-lg mx-auto">
                        <p class="mt-2">Tiara Adjeng Endrastyana, S.Psi., M.Psi., Psikolog</p>
                    </div>
                </div>
                <div class="item">
                    <div class="client-inners">
                        <img src="{{ asset('img/psychologists/utari.jpeg') }}" alt="Utari Krisnamurthi, M.Psi,. Psikolog" srcset="" class="max-w-fit rounded-lg mx-auto">
                        <p class="mt-2">Utari Krisnamurthi, M.Psi,. Psikolog</p>
                    </div>
                </div>
                <div class="item">
                    <div class="client-inners">
                        <img src="{{ asset('img/psychologists/vanessa.jpg') }}" alt="PT Rodeo Kerta Kencana" srcset="" class="max-w-fit rounded-lg mx-auto">
    ...
    <div class="lg:p-20 px-5 py-14 bg-pale-yellow faq">
        ...
        <div id="accordion-collapse" data-accordion="collapse">
            <h2 id="accordion-collapse-heading-1">
                <button type="button" class="flex items-center justify-between w-full p-5 font-medium text-left border border-b-0 border-gray-200 rounded-t-xl focus:ring-4 focus:ring-gray-200 bg-pale-orange text-gray-900" data-accordion-target="#accordion-collapse-body-1" aria-expanded="true" aria-controls="accordion-collapse-body-1">
            ...
            <h2 id="accordion-collapse-heading-2">
                <button type="button" class="flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-b-0 border-gray-200 " data-accordion-target="#accordion-collapse-body-2" aria-expanded="false" aria-controls="accordion-collapse-body-2">
            ...
            <h2 id="accordion-collapse-heading-3">
                <button type="button" class="flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-gray-200" data-accordion-target="#accordion-collapse-body-3" aria-expanded="false" aria-controls="accordion-collapse-body-3">

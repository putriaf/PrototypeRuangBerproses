...
<main class="p-6 sm:p-10 space-y-6 max-h-screen overflow-y-auto" id="myTabContent">
            ...
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="pcSubTab"
                ...
                <li class="mr-2" role="presentation">
                    <button
                        ...
                        id="pcList-tab" data-tabs-target="#pcList" type="button" role="tab" aria-controls="pcList"
                        aria-selected="true">Daftar Konseling Tersedia</button>
                </li>
                <li class="mr-2" role="presentation">
                    <button
                ...
                <section class="grid md:grid-cols-1">
                                                    ...
                                                    <div class="grid grid-cols-6 gap-6">
                                                        ...
                                                        <div class="col-span-6 sm:col-span-3">
                                                            ...
                                                            <input type="text" name="{{ $csf }}" id="{{ $csf }}"
                                                                ...
                                                                value="{{ old( $csf, $proc->$csf) }}" required="">
                                                        </div>
                                                        @endforeach
                                                    </div>
                                                </div>
                    ...
                    <div id="createpcListModal" tabindex="-1" aria-hidden="true"
                        ...
                        <div class="relative w-full max-w-2xl h-full md:h-auto">
                            <!-- Modal content -->
                            <form action="/admin/layanan/procounseling-list/tambah" method="POST" id="createpcList"
                                ...
                                <div class="p-6 space-y-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <select id="counselor_id" name="counselor_id" autocomplete="" required
                                                class="rounded-md">
                                                        ...
                                                        <div class="flex align-middle align-content-center">
                                                            ...
                                                            <a class="h-11 w-10 input-button cursor-pointer rounded-r-md bg-transparent border-gray-300 border-t border-b border-r"
                                                                ...
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    class="h-7 w-7 mt-2 ml-1" viewBox="0 0 20 20"
                                                                    fill="#c53030">
                                                                    <path fill-rule="evenodd"
                                                                        d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                                                        clip-rule="evenodd" />
        ...
        <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="pecSubTab"
                ...
                <li class="mr-2" role="presentation">
                    <button
                        class="inline-block p-4 rounded-t-lg border-b-2 text-blue-600 hover:text-blue-600 dark:text-blue-500 dark:hover:text-blue-500 border-blue-600 dark:border-blue-500"
                        id="pecList-tab" data-tabs-target="#pecList" type="button" role="tab" aria-controls="pecList"
                        aria-selected="true">Daftar Konseling Tersedia</button>
                </li>
                <li class="mr-2" role="presentation">
                    <button
                        class="inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 dark:border-transparent text-gray-500 dark:text-gray-400 border-gray-100 dark:border-gray-700"
                        id="pecReg-tab" data-tabs-target="#pecReg" type="button" role="tab" aria-controls="pecReg"
                        aria-selected="false">Data Pendaftaran</button>
                </li>
            </ul>
        </div>
        <div id="pecSubTabContent">
            <div class="p-4 rounded-lg dark:bg-gray-800" id="pecList" role="tabpanel" aria-labelledby="pecList-tab">
                <div class="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
                    <div class="mr-6">
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr
                                    ...
                                    <td class="py-4 px-6">
                                        <!-- Modal toggle -->
                                        <a href="#" type="button" data-modal-toggle="editpecListModal{{$pec->id}}"
                                            class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit
                                        </a>
                                        <a href="#" type="button" data-modal-toggle="deletepecListModal{{$pec->id}}"
                                            class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Delete
                                        </a>
                                    </td>
                                    ...
                                    <div id="editpecListModal{{$pec->id}}" tabindex="-1" aria-hidden="true"
                                        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center p-4 w-full md:inset-0 h-modal md:h-full">
                                        <div class="relative w-full max-w-2xl h-full md:h-auto rounded bg-white">
                                            <!-- Modal content -->
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr
                                    ...
                                    <td class="py-4 px-6">
                                        <!-- Modal toggle -->
                                        <a href="#" type="button" data-modal-toggle="editpecRegModal{{ $regpec->id }}"
                                            class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit
                                        </a>
                                    </td>
                                </tr>
    ...
    <div class="" id="supportGroup" role="tabpanel" aria-labelledby="supportGroup-tab">
        <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="sgSubTab"
                ...
                <li class="mr-2" role="presentation">
                    <button
                        class="inline-block p-4 rounded-t-lg border-b-2 text-blue-600 hover:text-blue-600 dark:text-blue-500 dark:hover:text-blue-500 border-blue-600 dark:border-blue-500"
                        id="sgList-tab" data-tabs-target="#sgList" type="button" role="tab" aria-controls="sgList"
                        aria-selected="true">Daftar Konseling Tersedia</button>
                </li>
                <li class="mr-2" role="presentation">
                    <button
        ...
        <div id="sgSubTabContent">
            <div class="p-4 rounded-lg dark:bg-gray-800" id="sgList" role="tabpanel" aria-labelledby="sgList-tab">
                <div class="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
                    <div class="mr-6">
        ...
        <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="psySubTab"
                ...
                <li class="mr-2" role="presentation">
                    <button
                        class="inline-block p-4 rounded-t-lg border-b-2 text-blue-600 hover:text-blue-600 dark:text-blue-500 dark:hover:text-blue-500 border-blue-600 dark:border-blue-500"
                        id="psyList-tab" data-tabs-target="#psyList" type="button" role="tab" aria-controls="pcList"
                        aria-selected="true">Daftar Psytalk Tersedia</button>
                </li>
                <li class="mr-2" role="presentation">
                    <button
                        class="inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 dark:border-transparent text-gray-500 dark:text-gray-400 border-gray-100 dark:border-gray-700"
                        id="psyReg-tab" data-tabs-target="#psyReg" type="button" role="tab" aria-controls="psyReg"
                        aria-selected="false">Data Pendaftaran</button>
                </li>
            </ul>
        </div>
            ...
            <div class="p-4 rounded-lg dark:bg-gray-800" id="psyList" role="tabpanel" aria-labelledby="psyList-tab">
                ...
                <section class="grid md:grid-cols-1">
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr
                                    ...
                                    <td class="py-4 px-6">
                                        <!-- Modal toggle -->
                                        <a href="/admin/program/psytalk-list/{{ $psytalk->id }}/edit" type="button"
                                    ...
                                    <div id="editpsyListModal{{ $psytalk->id }}" tabindex="-1" aria-hidden="true"
                                        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center p-4 w-full md:inset-0 h-modal md:h-full">
                                        <div class="relative w-full max-w-2xl h-full md:h-auto">
                                            <!-- Modal content -->
                                            <form action="/admin/layanan/psytalk-list/{{ $psytalk->id }}" method="POST"
                                                enctype="multipart/form-data"
                                                class="relative bg-white rounded-lg shadow dark:bg-gray-700"
                                                id="editpsyList">
                                                @method('put')
                                                    ...
                                                    <div class="grid grid-cols-6 gap-6">
                                                        ...
                                                        <div class="col-span-6 sm:col-span-3">
                                                            <label for="{{ $psyf }}"
                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama
                                                                Konselor</label>
                                                            <input type="text" name="{{ $psyf }}" id="{{ $psyf }}"
                                                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                                value="{{ old($psyf, $psytalk->$psyf) }}" required="">
                                                        </div>
                                                        @endforeach
                                                    </div>
                                                </div>
                                    ...
                                    <div id="deletepsyListModal{{ $psytalk->id }}" tabindex="-1" aria-hidden="true"
                                        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center p-4 w-full md:inset-0 h-modal md:h-full">
                                        <div class="relative w-full max-w-2xl h-full md:h-auto">
                                            <form action="/admin/layanan/psytalk-list/{{ $psytalk->id }}" method="post"
                                                enctype="multipart/form-data"
                    ...
                    <div id="createpsytalkListModal" tabindex="-1" aria-hidden="true"
                        ...
                        <div class="relative w-full max-w-2xl h-full md:h-auto">
                            <!-- Modal content -->
                            <form action="/admin/program/psytalk-list/tambah" method="POST" id="createpsytalkList"
                                enctype="multipart/form-data"
                                class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                @csrf
                                <!-- Modal header -->
        ...
        <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="kbSubTab"
                ...
                <li class="mr-2" role="presentation">
                    <button
                        class="inline-block p-4 rounded-t-lg border-b-2 text-blue-600 hover:text-blue-600 dark:text-blue-500 dark:hover:text-blue-500 border-blue-600 dark:border-blue-500"
                        id="kbList-tab" data-tabs-target="#kbList" type="button" role="tab" aria-controls="kbList"
                        aria-selected="true">Daftar Kelas Berproses Tersedia</button>
                </li>
                <li class="mr-2" role="presentation">
                    <button
                        class="inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 dark:border-transparent text-gray-500 dark:text-gray-400 border-gray-100 dark:border-gray-700"
    ...
    <div class="" id="artikel" role="tabpanel" aria-labelledby="artikel-tab">
        <div class="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
            ...
            <div class="flex flex-wrap items-start justify-end -mb-3 text-sm">
                <a href="/admin/artikel-berproses/tambah">
                    <button data-modal-toggle="createArtikelModal"
                        class="inline-flex px-5 py-3 text-white bg-blue-600 hover:bg-purple-700 focus:bg-blue-700 rounded-md ml-6 mb-3">
                        <svg aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                            class="flex-shrink-0 h-4 w-4 text-white -ml-1 mr-2 self-center">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div id="createArtikelModal" tabindex="-1" aria-hidden="true"
            class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center p-4 w-full md:inset-0 h-modal md:h-full">
            <div class="relative w-full max-w-2xl h-full md:h-auto">
                <!-- Modal content -->
                <form action="/admin/layanan/procounseling-list/tambah" method="POST" id="createpcList"
                    enctype="multipart/form-data" id="createartikel"
                    class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    @csrf
                    <!-- Modal header -->
        ...
        <section class="grid md:grid-cols-1">
            ...
            <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr
                            ...
                            <td class="py-4 px-6">
                                <!-- Modal toggle -->
                                <a href="/admin/artikel-berproses/{{ $artikel->id }}/edit" type="button"
                                    data-modal-toggle="editartikelModal"
                                    class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit
                                </a>
                ...
                <!-- Delete Pro Counseling List modal -->
                <div id="deleteartikelModal1" tabindex="-1" aria-hidden="true"
                    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center p-4 w-full md:inset-0 h-modal md:h-full">
                    <div class="relative w-full max-w-2xl h-full md:h-auto">
                        <form action="" method="post" enctype="multipart/form-data"
                            class="relative bg-white rounded-lg shadow dark:bg-gray-700">

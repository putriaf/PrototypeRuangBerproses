...
<head>
    ...
    <link rel="icon" href="{{ asset('https://ruangberproses-dev.site/img/ruang-berproses/rb-only-logo.png') }}">
    <link href="{{ asset('https://ruangberproses-dev.site/css/app.css') }}" rel="stylesheet">

...
<section class="-mt-20 font-quicksand">
    <div
        class="pt-52 sm:px-12 h-screen bg-jumbotron-home bg-no-repeat bg-cover bg-center bg-fixed mx-auto text-center text-slate-100 xl:px-64">
        ...
        <h2 class="font-light text-sm sm:text-md px-8 sm:px-6 mb-6 sm:mb-10  lg:px-16">Butuh ruang aman dan
            nyaman untuk bercerita? Tenaga profesional siap mendampingimu berproses menuju versi terbaik!</h2>
        <a href="" class="bg-gradient-to-r from-[#FB8D66] px-8 py-2 sm:px-10 sm:py-4 rounded-3xl font-semibold">Daftar
            Sekarang</a>
    </div>
                    ...
                    <div class="container absolute block -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                        <div class="grid grid-cols-3 gap-10 place-items-center lg:mx-28">
                            <img src="{{ asset('img/illustrations/virtual-support-group.jpg') }}"
                                class="rounded-full w-2/3 justify-self-end" alt="Virtual Support Group">

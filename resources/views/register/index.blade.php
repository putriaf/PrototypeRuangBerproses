    ...
    <form method="POST" action="/register" enctype="multipart/form-data" class="lg:mr-52">
      ...
      <div class="grid grid-cols-2 xs:grid-cols-1">
        <div class="xs:mr-4 sm:mr-4 md:mr-4 lg:mr-16">
          <div class="input-group relative z-0 w-full group xs:mt-4 sm:mt-4 md:mt-4 lg:mt-6">
            <input type="email" name="email" id="email"
              class="@error('email') is-invalid @enderror input block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
              value="{{ old('email') }}" placeholder=" " required="" autocomplete="off">
            <label for="email"
            ...
            <svg class="icon icon-success hidden" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
              ...
              <g fill="none">
                <path d="M9 12l2 2 4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0z" stroke-width="2" stroke-linecap="round"
            ...
            <svg class="icon icon-error hidden" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
              ...
              <g fill="none">
                <path d="M12 8v4m0 4h.01M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0z" stroke-width="2" stroke-linecap="round"
                  stroke-linejoin="round"></path>
              </g>
            </svg>
          </div>
        ...
        <div class="xs:mr-4 sm:mr-4 md:mr-4 lg:mr-16">
          <div class="input-group relative z-0 xs:mt-4 sm:mt-4 md:mt-4 lg:mt-6 w-full group">
            <input type="text" name="no_telp" id="no_telp"
              class="@error('no_telp') is-invalid @enderror input block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-slate-50 rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
        ...
        <div class="xs:mr-4 sm:mr-4 md:mr-4 lg:mr-16">
          <div class="input-group relative z-0 xs:mt-4 sm:mt-4 md:mt-4 lg:mt-6 w-full group">
            <input type="text" name="nama" id="nama"
              class="@error('nama') is-invalid @enderror input block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-slate-50 rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
        ...
        <div class="xs:mr-4 sm:mr-4 md:mr-4 lg:mr-16">
          <div class="input-group relative z-0 xs:mt-4 sm:mt-4 md:mt-4 lg:mt-6 w-full group">
            <input type="text" name="username" id="username"
              class="@error('username') is-invalid @enderror input block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-slate-50 rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
      ...
      <div class="grid grid-cols-2">
        <div class="xs:mr-4 sm:mr-4 md:mr-4 lg:mr-16">
          <div class="input-group relative z-0 w-full group">
          ...
          <div class="input-group relative z-0 xs:mt-4 sm:mt-4 md:mt-4 lg:mt-6 w-full group">
            <div class="">
              <input type="password" name="password" id="password"
                class="input block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-slate-50 rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
        ...
        <div class="xs:mr-4 sm:mr-4 md:mr-4 lg:mr-16">
          <div class="input-group relative z-0 xs:mt-4 sm:mt-4 md:mt-4 lg:mt-6 w-full group">
            <input type="password" name="password_confirm" id="password_confirm"
              class="@error('password_confirm') is-invalid @enderror input block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-slate-50 rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
      ...
      <button type="submit" id="submit-btn"
        class="flex xs:mx-auto xs:mt-5 sm:mt-8 md:mt-8 lg:mt-10 text-white font-bold bg-red-500 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center lg:min-w-[2/3]"><span
          id="submit-label">Daftar
          Sekarang</span>
        <svg aria-hidden="true" id="loading-svg"
          class="hidden ml-3 w-6 h-6 text-gray-200 animate-spin dark:text-gray-600 fill-dark-blue" viewBox="0 0 100 101"

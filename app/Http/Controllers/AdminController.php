...
class AdminController extends Controller
{
    ...
    public function index()
    {
        ...
        $regpeercounseling_fields = ["user_id", "peercounseling_id", "screening_id", "latar_belakang", "tujuan", "keluhan", "preferensi_jk_konselor", "consent_sharing", "consent_screening", "bukti_transfer", "status_pendaftaran"];

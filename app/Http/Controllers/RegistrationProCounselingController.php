...
class RegistrationProCounselingController extends Controller
{
    ...
    {
        $response = Http::get('https://be.ruangberproses.id/api/admin/layanan/procounseling-list');
    ...
    public function store(Request $request)
    {
        ...
        $response = Http::asForm()->post("https://be.ruangberproses.id/api/layanan/professional-counseling/daftar", [
    ...
    {
        $response = Http::delete("https://be.ruangberproses.id/api/admin/layanan/professional-counseling/" . $id);
